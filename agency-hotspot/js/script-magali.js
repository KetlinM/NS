$(window).on("load", function () {
    ...
    if($(window).width() < 1280) {
        ...
        /* @@! */
        $('#main-menu > li.nav-item > a').each((i, a) => {
            mainMenuData.titles.push(a.innerText);
            mainMenuData.anchors.push(a.attributes['href'].value.replace('#', ''));
            mainMenuData.icons.push(a.attributes['data-icon'].value);
        });
        ...
        $('#pagepiling').pagepiling({
            ...
            navigation: {
                ...
                /* @@! */
                'titles': mainMenuData.titles,
                'icons': mainMenuData.icons
            },
