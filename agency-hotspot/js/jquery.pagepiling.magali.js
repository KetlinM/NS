        ...
        function addVerticalNavigation() {
            ...
            for (var cont = 0; cont < $('.pp-section').length; cont++) {
                ...
                if (options.navigation.tooltips !== 'undefined') {
                    tooltip = options.navigation.tooltips[cont];
                    if (typeof tooltip === 'undefined') { tooltip = ''; }
                }
                /* @@! */
                if (options.navigation.titles !== 'undefined') {
                    title = options.navigation.titles[cont];
                    if (typeof title === 'undefined') { title = ''; }
                }
                /* @@! */
                if (options.navigation.icons !== 'undefined') {
                    icon = options.navigation.icons[cont];
                    if (typeof icon === 'undefined') { icon = ''; }
                }

                /* @@! */
                nav.find('ul').append('<li><a href="#' + link + '"><i class="' + icon + '"></i><span>' + title + '</span></a></li>');
